...
IDS2017_ALL_FLOWS = {'attackers': ['172.16.0.1','205.174.165.69','205.174.165.70','205.174.165.71','205.174.165.72','205.174.165.73'], 'victims': ['192.168.10.' + str(x) for x in range(1,255)]}
...
def main(argv):
    ...
    parser.add_argument('-t', '--dataset_type', nargs='+', type=str,
                        help='Type of the dataset. Available options are: IDS2017, IDS2018, DOS2019, SYN2020')
